package com.ddinfo.flashman.view.RecyclerViewViewPager;
...
public class RecyclerViewPager extends RecyclerView {
  ...
  private void initAttrs(Context context, AttributeSet attrs, int defStyle) {
    ...
    mSinglePageFling =
        a.getBoolean(R.styleable.RecyclerViewPager_rvp_singlePageFling, mSinglePageFling);
    a.recycle();
  }
    ...
    if (getLayoutManager() != null && getLayoutManager() instanceof LinearLayoutManager) {
      ...
      LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(getContext()) {
        ...
        public PointF computeScrollVectorForPosition(int targetPosition) {
          ...
          return ((LinearLayoutManager) getLayoutManager()).computeScrollVectorForPosition(
              targetPosition);
        }
  ...
  protected RecyclerViewPagerAdapter ensureRecyclerViewPagerAdapter(Adapter adapter) {
    return (adapter instanceof RecyclerViewPagerAdapter) ? (RecyclerViewPagerAdapter) adapter
