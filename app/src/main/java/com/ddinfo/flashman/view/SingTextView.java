package com.ddinfo.flashman.view;
...
/**
 * Title: 排版TextView
 * Created by fuh on 2016/11/28.
 * Email：unableApe@gmail.com
 */
public class SingTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public SingTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if(attrs!=null){
    ...
    public SingTextView(Context context, float textSize, int textColor, float paddingLeft, float paddingRight, float marginLeft, float marginRight){
        super(context);
